// Set default color
const colorpicker=document.getElementById("colorPicker").value = "#E89623"; // Set to red as an example

// Set height and width
document.getElementById("colorPicker").style.height = "50px";
document.getElementById("colorPicker").style.width = "50px";
...
let alltrailer = ["River Rock","Clear Crush Gravel","4x4 PT Ties (8' Piece)","River Rock","Abbotsford Standard","Garden Soil","7' Cedars" ];
...
let allselecttemplate = ["River Rock","Clear Crush Gravel","4x4 PT Ties (8' Piece)","River Rock","Abbotsford Standard","Garden Soil","7' Cedars" ];
